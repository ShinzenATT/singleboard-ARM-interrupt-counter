...
WorkspacePath          :=/home/shinzenatt/OneDrive/Maskinorienterad-programmering/lab-4
ProjectPath            :=/home/shinzenatt/OneDrive/Maskinorienterad-programmering/lab-4/lab-4-4
...
PostBuild:
	...
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/lab-4-4.elf Debug/lab-4-4.s19
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/lab-4-4.elf > Debug/lab-4-4.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "/home/shinzenatt/OneDrive/Maskinorienterad-programmering/lab-4/lab-4-4/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
